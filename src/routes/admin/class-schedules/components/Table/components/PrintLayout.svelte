    ...
    <section class="flex flex-col border-2">
      ...
      {#each Array(10)}
        <div class="grid grid-cols-[1fr,2fr,1fr,1fr,1fr] border-b-2">
          ...
          <div class="flex items-center justify-center border-r-2 p-2">
            <span class="">Database Administration</span>
          </div>
