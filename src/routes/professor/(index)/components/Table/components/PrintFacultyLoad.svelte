  ...
  <AlertDialog.Content class="flex h-full max-w-full flex-col overflow-auto text-xs">
    ...
    <section>
      ...
      <section class="grid grid-cols-[1fr,2fr,1fr,2fr] border-2 border-t-0">
        ...
        <div class="flex border-r-2 p-2">
          <span class="text-center"
            >{$page.data.user?.user_metadata?.firstName?.toUpperCase()}
            {$page.data.user?.user_metadata?.middleName?.toUpperCase()[0]}.
            {$page.data.user?.user_metadata?.lastName?.toUpperCase()}</span
          >
        </div>
        <div class="flex border-r-2 p-2">
        ...
        <div class="flex p-2">
          <span class="text-center">{$page.data.user?.user_metadata?.department}</span>
        </div>
      </section>
      ...
      <section class="grid grid-cols-[1fr,2fr,1fr,2fr] border-2 border-t-0">
        ...
        <div class="flex border-r-2 p-2">
          <span class="text-center"
            >{$page.data.user?.user_metadata?.schedule?.available.toUpperCase()}</span
          >
        </div>
        <div class="flex border-r-2 p-2">
          <span class="text-center"></span>
    ...
    <section>
      <span class="font-semibold">
        {$page.data.user?.user_metadata?.schedule?.available.toUpperCase() === 'Part Time'
          ? 'PART-TIME LOAD'
          : 'REGULAR LOAD'}
      </span>
      ...
      <span class="font-semibold">
        TOTAL {$page.data.user?.user_metadata?.schedule?.available.toUpperCase() === 'Part Time'
          ? 'PART-TIME LOAD'
          : 'REGULAR LOAD'}:
