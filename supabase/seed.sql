...
CREATE OR REPLACE TRIGGER "log_class_schedules_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."class_schedules_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();



CREATE OR REPLACE TRIGGER "log_professors_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."professors_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();



CREATE OR REPLACE TRIGGER "log_programs_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."programs_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();



CREATE OR REPLACE TRIGGER "log_rooms_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."rooms_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();



CREATE OR REPLACE TRIGGER "log_school_years_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."school_years_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();



CREATE OR REPLACE TRIGGER "log_sections_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."sections_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();



CREATE OR REPLACE TRIGGER "log_subjects_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."subjects_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();



CREATE OR REPLACE TRIGGER "log_year_levels_changes" AFTER INSERT OR DELETE OR UPDATE ON "public"."year_levels_tb" FOR EACH ROW EXECUTE FUNCTION "public"."log_table_changes"();
